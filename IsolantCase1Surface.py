...
barrier3 = lambda x,y,z: min(max((z-zmax)**2 + (y-0.5)**2 - (r + eps)**2, x-xcen), max((x-xcen)**2 + (y-0.5)**2 - (r + eps)**2,z-zmax,zmin-z), max((z-zmin)**2 + (y-0.5)**2 - (r + eps)**2, xcen-x) )
barrier4 = lambda x,y,z : (z-zmax)**2 + (y-0.5)**2 +(x-xcen)**2 - (r+eps)**2
barrier5 = lambda x,y,z : (z-zmin)**2 + (y-0.5)**2 +(x-xcen)**2 - (r+eps)**2
...
phi11 = lambda x,y,z : max((z-zmax)**2 + (y-0.5)**2 - r**2, x-xcen)
phi12 = lambda x,y,z : max((x-xcen)**2 + (y-0.5)**2 - r**2,z-zmax,zmin-z)
phi13 = lambda x,y,z : max((z-zmin)**2 + (y-0.5)**2 - r**2, xcen-x)
phi14 = lambda x,y,z : (z-zmax)**2 + (y-0.5)**2 +(x-xcen)**2 - r**2
phi15 = lambda x,y,z : (z-zmin)**2 + (y-0.5)**2 +(x-xcen)**2 - r**2
phi1 = lambda x,y,z: min(phi11(x,y,z), phi12(x,y,z),  phi13(x,y,z), phi14(x,y,z), phi15(x,y,z))
phi21 = lambda x,y,z : max((z-zmax)**2 + (y-0.5)**2 - R**2, x-xcen) #max(-x+eps,(z-zmax)**2 + (y-0.5)**2 - R**2, x-xcen)
phi22 = lambda x,y,z : max((x-xcen)**2 + (y-0.5)**2 - R**2,z-zmax,zmin-z)
phi23 = lambda x,y,z : max((z-zmin)**2 + (y-0.5)**2 - R**2, xcen-x) #max(x+eps-1.,(z-zmin)**2 + (y-0.5)**2 - R**2, xcen-x)
phi24 = lambda x,y,z : (z-zmax)**2 + (y-0.5)**2 +(x-xcen)**2 - R**2
phi25 = lambda x,y,z : (z-zmin)**2 + (y-0.5)**2 +(x-xcen)**2 - R**2
phi02 = lambda x,y,z: min(phi21(x,y,z), phi22(x,y,z),  phi23(x,y,z), phi24(x,y,z),  phi25(x,y,z)) #(z-0.5)**2 + (y-0.5)**2 - 0.45**2
