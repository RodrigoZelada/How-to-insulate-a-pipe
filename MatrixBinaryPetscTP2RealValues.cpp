...
const double ks = 11.;//111. 111.*1e-6; //thermal diffusivity D or alpha of cupper;
...
double ny(double x,double y, double z){return (y-0.5)/sqrt(pow(y-0.5,2.)+pow(z-0.5,2.));}
double nz(double x,double y, double z){return (z-0.5)/sqrt(pow(y-0.5,2.)+pow(z-0.5,2.));}
...
double dythetay(double x,double y, double z){return -tau*pow(z-0.5,2.)/pow(pow(y-0.5,2) + pow(z-0.5,2),1.5);}
double dzthetay(double x,double y, double z){return tau*((y-0.5)*(z-0.5))/pow(pow(y-0.5,2) + pow(z-0.5,2),1.5);}

double dxthetaz(double x,double y, double z){return 0.;}
double dythetaz(double x,double y, double z){return tau*((y-0.5)*(z-0.5))/pow(pow(y-0.5,2) + pow(z-0.5,2),1.5);}
double dzthetaz(double x,double y, double z){return -tau*pow(y-0.5,2.)/pow(pow(y-0.5,2) + pow(z-0.5,2),1.5);}
