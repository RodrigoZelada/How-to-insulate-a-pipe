void adjointDiscontinuousVentcell3D(Mat A, Vec b, mesh3D &Th, vector<double> &G, vector<double> &kappa, vector<vector<double>> &u, map<int,int> Gamma, mesh3D &Th2, DirichletBC &DBC1, DirichletBC &DBC2)
{
	int N = Th.ntet;
	int Nt = Th.nt;
